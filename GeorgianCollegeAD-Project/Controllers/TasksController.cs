...
namespace GeorgianCollegeAD_Project.Controllers
{
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TaskId,TaskName,TaskTypeID,TaskDescription,TaskNotes")] Task task)
        {
            ...
            ViewData["TaskTypeID"] = new SelectList(_context.TaskTypes, "TaskTypeId", "TaskTypeName", task.TaskTypeID);
            return View(task);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaskId,TaskName,TaskTypeID,TaskDescription,TaskNotes")] Task task)
        {
            if (id != task.TaskId)
            {
                return NotFound();
